...
Section TWO_GEN_COSET_ENUM.
  ...
  Definition M11_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) M11_gens).
  ...
  (* Finished transaction in 3368.17 secs (3354.588u,11.231s) (successful) *)
...
Section THREE_GEN_COSET_ENUM.
  ...
  Definition M12_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) M12_gens).
  ...
  (* Finished transaction in 17412.734 secs (17326.555u,50.783s) (successful) *)
