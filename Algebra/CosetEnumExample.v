...
Section TWO_GEN_COSET_ENUM.
  ...
  Definition T_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) T_gens).
  ...
  Definition O_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) O_gens).
  ...
  Definition I_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) I_gens).
  ...
  Definition F4_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) F4_gens).
  ...
  Definition H4_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) H4_gens).
  ...
  Definition test1_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) test1_gens).
  Definition test1_sub_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) test1_sub_gens).
  ...
  Definition test2_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) test2_gens).
  Definition test2_sub_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) test2_sub_gens).
  ...
  Definition test3_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) test3_gens).
...
Section THREE_GEN_COSET_ENUM.
  ...
  Definition Ih_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) Ih_gens).

  Eval native_compute in all_gen_reps.
  ...
  Definition Ih_sub_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) Ih_sub_gens).
  ...
  Definition L_2_27_gens_rep :=
    Eval native_compute in (map (map alphabet_to_positive) L_2_27_gens).
